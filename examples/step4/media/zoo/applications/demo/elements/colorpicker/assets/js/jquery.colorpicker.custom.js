 ...
 * 
 * Line 157, several improvements to downSelector function - now is possible to select color with the click also
 */
(function ($) {
    var ColorPicker = function () {
            var ids = {},
                ...
                downSelector = function (ev) {
					...
					current.cal.find('.colorpicker_color').bind('mouseleave', function(){
						$(document).unbind('mousedown');
						$(document).bind('mousedown', current, hide);
					})
                },
